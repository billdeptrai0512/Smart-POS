            ...
            <div className="px-6 pt-4 pb-4">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        {/* Only hidden when an order exists AND the screen is ultra-narrow
                            (e.g. Z Fold cover ~280px): there the Giảm giá pill + label + price
                            can't share one row, and the bold number is self-evidently the total.
                            With an empty cart there's no pill, so the label always fits — keep it.
                            nowrap prevents a mid-word "Tổng / Cộng" split on the borderline. */}
                        <span className={`text-text-secondary text-sm font-bold uppercase tracking-wider whitespace-nowrap ${hasOrder ? 'hidden min-[360px]:inline' : ''}`}>Tổng cộng</span>
                    </div>
