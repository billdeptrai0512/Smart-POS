...
import { ClipboardCopy, Check, ChevronRight, Loader, Share2, Copy } from 'lucide-react'
    ...
    return (
        ...
        >
                <ModalHeader
                    ...
                    subtitle={<>Nguồn: <span className="text-primary font-bold">{sourceAddress.name}</span></>}
                    onClose={onClose}
                    hideClose={loading}
                />
