-- =============================================
-- Fix get_branches_today_stats & get_today_stats:
-- Exclude soft-deleted orders (deleted_at IS NOT NULL)
-- =============================================
-- Both RPCs were counting deleted orders in revenue and cups totals.
-- This also caused incorrect stats on AddressSelectPage branch tiles.
