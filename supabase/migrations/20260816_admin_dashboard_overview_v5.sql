-- ============================================================
-- Admin Dashboard v5 — tách "đã bỏ hẳn" ra khỏi KPI "Cần chú ý".
--
-- reason 'inactive' trước đây chỉ có ngưỡng DƯỚI (≥14 ngày im lặng), không có
-- ngưỡng TRÊN — 1 địa chỉ im 20 ngày và 1 địa chỉ im 200 ngày (gần như chắc
-- chắn đã dẹp tiệm, gọi lại vô ích) bị tính chung, làm phồng "Cần chú ý" bằng
-- case không còn actionable.
--
-- Thêm ngưỡng 90 ngày: 14-90 ngày vẫn là 'inactive' (còn cứu được, giữ nguyên
-- hành vi cũ). ≥90 ngày tách thành 'dormant' — LOẠI khỏi attention_dedup nên
-- không kéo attention_total_count, expose riêng qua dormant_addresses/
-- dormant_count để trang đối soát hiển thị tham khảo ở cuối, không tính KPI.
--
-- "Chưa từng hoạt động" (last_active_at NULL) dùng valid_from của gói trả phí
-- hiện tại làm mốc thay thế — trả phí 90 ngày mà 0 đơn/ca cũng là dormant.
--
