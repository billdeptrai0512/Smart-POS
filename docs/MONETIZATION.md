...
| **Chưa full-close lần nào** (0 sub row — xem §1) | `Đang dùng thử` (không có "còn X ngày" — chưa đếm ngược) | text-secondary, dot success |
| Hết hạn (có sub row nhưng không cái nào còn hạn hôm nay) | `Mở khoá báo cáo` | text-primary, mời chào |
